 ...
 */
@Component
public class RequestClubJoinAlarmContentGenerator implements AlarmMessageGenerator<RequestJoinClubEvent> {
    ...
    @Override
    public AlarmMessage generate(final RequestJoinClubEvent event) {
