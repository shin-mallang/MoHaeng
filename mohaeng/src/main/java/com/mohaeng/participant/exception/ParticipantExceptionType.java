...
public enum ParticipantExceptionType implements BaseExceptionType {
    ...
    CAN_NOT_CHANGED_TO_PRESIDENT_ROLE(605, HttpStatus.BAD_REQUEST, "회장 역할로는 변경할 수 없습니다."),
    NO_AUTHORITY_CHANGE_TARGET_ROLE(606, HttpStatus.FORBIDDEN, """
            ...
            """),
    CAN_NOT_CHANGE_TO_OTHER_CLUB_ROLE(607, HttpStatus.BAD_REQUEST, "다른 모임의 역할로는 변경할 수 없습니다."),
    ;
