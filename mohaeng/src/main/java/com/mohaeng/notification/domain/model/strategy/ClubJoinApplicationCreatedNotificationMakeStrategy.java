 ...
 */
@Component
public class ClubJoinApplicationCreatedNotificationMakeStrategy extends NotificationMakeStrategy<ApplicationFormWrittenEvent> {

    @Override
    public List<Notification> makeNotifications(final ApplicationFormWrittenEvent event) {
