...
public class ClubJoinApplicationRequestedNotificationResponse extends NotificationResponse {

    private Long clubId;  // 가입을 요청한 모임 ID
    private Long applicantId;  // 가입 신청자의 Member ID
    private Long applicationFormId;  // 가입 신청서 ID

    public ClubJoinApplicationRequestedNotificationResponse(final Long id,
