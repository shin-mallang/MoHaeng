...
public class NotificationControllerMapper {
    ...
    public static NotificationResponse toResponseDto(final NotificationDto notificationDto) {
        ...
        if (notificationDto instanceof ClubJoinApplicationRequestedNotificationDto dto) {
            return new ClubJoinApplicationRequestedNotificationResponse(dto.id(), dto.createdAt(), dto.isRead(), dto.getClass().getSimpleName(), dto.clubId(), dto.applicantId(), dto.applicationFormId());
        }
        ...
        /**
         ...
         new ClubJoinApplicationRequestedNotificationResponse(dto.id(), dto.createdAt(), dto.isRead(), dto.getClass().getSimpleName(), dto.clubId(), dto.applicantId(), dto.applicationFormId());
