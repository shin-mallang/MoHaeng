...
public class DeleteParticipantCauseByClubDeletedNotificationResponse extends NotificationResponse {

    private final String clubName;  // 제거된 모임 이름
    private final String clubDescription;  // 제거된 모임의 설명

    public DeleteParticipantCauseByClubDeletedNotificationResponse(final Long id,
