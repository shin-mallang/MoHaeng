...
@Entity
@DiscriminatorValue("OfficerApproveApplicationEvent")
public class OfficerApproveApplicationEventHistory extends BaseEventHistory {
    ...
    protected OfficerApproveApplicationEventHistory() {
    }

    public OfficerApproveApplicationEventHistory(final Long managerMemberId,
