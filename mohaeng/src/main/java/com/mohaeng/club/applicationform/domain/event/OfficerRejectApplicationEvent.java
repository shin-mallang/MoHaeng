...
import com.mohaeng.club.applicationform.domain.event.history.OfficerRejectApplicationEventHistory;
 ...
 */
public class OfficerRejectApplicationEvent extends NotificationEvent {
     ...
     */
    public OfficerRejectApplicationEvent(final Object source,
    ...
    public BaseEventHistory history() {
        return new OfficerRejectApplicationEventHistory(officerMemberId, officerParticipantId, applicantMemberId, applicationFormId);
    }

    @Override
    public String toString() {
        return "OfficerRejectApplicationEvent{" +
